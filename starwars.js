...
const descriprions = {
    planets: `<h3>Welcome to the page of annoying planets of those stupid movies🤢 I hate them!</h3> <p>${descriprion}</p> <br> <img class='desc_img' src='./img/tatooine.jpg'>`,
    people: `<h3>Welcome to the page of annoying characters of those stupid movies🤢 I hate them!</h3> <p>${descriprion}</p> <br> <img class='desc_img' src='./img/luck.jpg'>`,
    starships: `<h3>Welcome to the page of annoying starships of those stupid movies🤢 I hate them!</h3> <p>${descriprion}</p> <br> <img class='desc_img' src='./img/deathstar.png'>`,
}
